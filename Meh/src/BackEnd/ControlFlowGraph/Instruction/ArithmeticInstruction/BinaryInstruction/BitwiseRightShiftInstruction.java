...
public class BitwiseRightShiftInstruction extends BinaryInstruction {
    public BitwiseRightShiftInstruction(VirtualRegister destination, Operand operand1, Operand operand2) {
    ...
    public static Instruction getInstruction(Operand destination, Operand operand1, Operand operand2) {
        if (destination instanceof VirtualRegister) {
            return new BitwiseRightShiftInstruction((VirtualRegister)destination, operand1, operand2).rebuild();
        }
    ...
    public String toString() {
        return String.format("%s = shr %s %s", destination, operand1, operand2);
    }
}
