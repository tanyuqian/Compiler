...
import BackEnd.ControlFlowGraph.Instruction.ArithmeticInstruction.BinaryInstruction.GreaterThanOrEqualToInstruction;
...
public class GreaterThanOrEqualToExpression extends BinaryExpression {
    public GreaterThanOrEqualToExpression(Type type, boolean isLeftValue, Expression left, Expression right) {
    ...
    public static Expression getExpression(Expression left, Expression right) {
        if ((left.type instanceof IntType) && (right.type instanceof IntType)) {
            ...
            return new GreaterThanOrEqualToExpression(new BoolType(), false, left, right);
