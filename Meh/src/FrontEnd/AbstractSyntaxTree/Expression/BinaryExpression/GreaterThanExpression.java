...
import BackEnd.ControlFlowGraph.Instruction.ArithmeticInstruction.BinaryInstruction.GreaterThanInstruction;
...
public class GreaterThanExpression extends BinaryExpression {
    public GreaterThanExpression(Type type, boolean isLeftValue, Expression left, Expression right) {
    ...
    public static Expression getExpression(Expression left, Expression right) {
        if ((left.type instanceof IntType) && (right.type instanceof IntType)) {
            ...
            return new GreaterThanExpression(new BoolType(), false, left, right);
            ...
            if ((left instanceof StringConstant) && (right instanceof StringConstant)) {
                ...
                return FunctionCallExpression.getExpression(
                        (Function)Environment.symbolTable.get("__builtin_string_greaterThan").type,
