...
public class Compiler {
	...
	public static Collection<Object[]> data() {
		...
		for (File file : new File("data/compiler/mx/").listFiles()) {
			if (file.isFile() && file.getName().endsWith(".mx")) {
				parameters.add(new Object[]{"data/compiler/mx/" + file.getName()});
			}
		}
		for (File file : new File("data/final/mx/").listFiles()) {
			if (file.isFile() && file.getName().endsWith(".mx")) {
				parameters.add(new Object[]{"data/final/mx/" + file.getName()});
			}
		}
		return parameters;
	}
