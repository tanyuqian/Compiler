 ...
 */
public class BranchCompareGreater extends BranchCompare {
    public BranchCompareGreater() {
        super();
    }

    public BranchCompareGreater(DataValue lhs, DataValue rhs, IRLabel gotoLabel) {
